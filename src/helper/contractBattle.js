...
import finish_3_dev from "./jsonBattle/finish_3_dev.json";
import finish_3_prod from "./jsonBattle/finish_3_prod.json";

// Active Hash Wars
export const DEV_ACTIVE_HASH_WARS_ADDRESS = "0x23DCD73F227B2ab4BD7199a3996937d8f4C148B6";
export const PROD_ACTIVE_HASH_WARS_ADDRESS = "0x23DCD73F227B2ab4BD7199a3996937d8f4C148B6";
...
export const DEV_FINISHED_HASH_WARS_ADDRESS_3 = "0x392f6FD88A991bFa23bcab29D49dd1f3a300e7c8";
export const PROD_FINISHED_HASH_WARS_ADDRESS_3 = "0x392f6FD88A991bFa23bcab29D49dd1f3a300e7c8";
...
export const finishedHashWars = [
  ...
  },
  {
    round: 3,
    dev: {
      address: DEV_FINISHED_HASH_WARS_ADDRESS_3,
      abi: finish_3_dev
    },
    prod: {
      address: PROD_FINISHED_HASH_WARS_ADDRESS_3,
      abi: finish_3_prod
    }
  },
];